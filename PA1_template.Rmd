...
* Calculate and report the mean and median total number of steps taken per day. Mean is `r mean(totalStepsPerDay$steps)` and median is `r median(totalStepsPerDay$steps)`.
