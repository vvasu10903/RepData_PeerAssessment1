...
* Mean and Median values are still pretty much the same even after imputing the missing value - Mean = `r as.integer(mean(totalStepsByDay$steps))` and Median = `r as.integer(median(totalStepsByDay$steps))`.
